...
var Animate = {
            ...
            for (var key in goto)
            {
                ...
                if (isNaN(goto[key]))
                {
                    ...
                    for (var key2 in goto[key])
                    {
                        ...
                        start[i][j] = Animate._correctDOM(key2, start[i][j]);
                ...
                else
                {
                    ...
                    start[i] = Animate._correctDOM(key, start[i]);
    ...
    _correctDOM: function(key, value)
    {
        switch (key)
        {
        case 'opacity':
    ...
    tint: function(object, tint, duration, options, ease)
    {
        ...
        return Animate.to(colorFrom, colorTo, duration, options, ease);
    },
    ...
    shake: function(object, amount, duration, options, ease)
    {
        ...
        options.onDone = done;
        object.shake = 0;
        return Animate.to(object, {shake: 1}, duration, options, ease);
    },
    ...
    toArray: function(list, goto, duration, options, ease)
    {
        ...
        options.onDone = done;
        Animate.to(list[0], goto, duration, options, ease);
    },
